...
let OtpController = class OtpController {
    ...
    async verifyUser(otpPayload, req) {
...
__decorate([
    ...
    (0, common_1.Patch)('/verify_user'),
    __param(0, (0, common_1.Body)()),
    __param(1, (0, common_1.Req)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [otp_dto_1.OtpCodePayloadDto, Object]),
    __metadata("design:returntype", Promise)
], OtpController.prototype, "verifyUser", null);
__decorate([
    (0, common_1.UseGuards)(jwt_guard_1.JwtAuthGuard),
    (0, common_1.Post)('/resend_token'),
